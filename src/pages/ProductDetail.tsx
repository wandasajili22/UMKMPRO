...
const PRODUCTS = [
  ...
  { id: '5', name: 'Madu Hutan Asli', price: 120000, description: 'Madu hutan alami tanpa campuran bahan kimia. Dipanen langsung dari hutan tropis Indonesia dengan kualitas premium.', stock: 25, category: 'Kesehatan', images: ['/images/Madu_Hutan_Asli.png'], slug: 'madu-hutan-asli' },
  { id: '6', name: 'Keripik Tempe Premium', price: 25000, description: 'Keripik tempe renyah dengan bumbu khas Nusantara. Cocok dijadikan camilan sehat dan lezat.', stock: 100, category: 'Kuliner', images: ['/images/Keripik_Tempe_Premium.png'], slug: 'keripik-tempe-premium' },
  { id: '7', name: 'Gantungan Kunci Kayu', price: 15000, description: 'Gantungan kunci handmade berbahan kayu alami dengan desain unik dan elegan.', stock: 40, category: 'Kriya', images: ['/images/Gantungan_Kunci_Kayu.png'], slug: 'gantungan-kunci-kayu' },
  { id: '8', name: 'Totebag Kanvas Lukis', price: 65000, description: 'Totebag berbahan kanvas premium dengan lukisan handmade yang artistik dan modern.', stock: 20, category: 'Fashion', images: ['/images/Totebag_Kanvas_Lukis.png'], slug: 'totebag-kanvas-lukis' },
];
